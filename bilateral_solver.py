...
def bilateral_solver_output(img_pth, target, sigma_spatial = 16, sigma_luma = 4, sigma_chroma = 4,threhold=0.5) : 
    ...
    binary_solver = ndimage.binary_fill_holes(output_solver>threhold)
